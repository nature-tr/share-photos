    ...
    <View className="page-root">
      ...
      <View className="top-bar">
        ...
        <View className="top-right">
          {user ? (
            <>
              <View className="top-icon-btn" onClick={() => Taro.navigateTo({ url: '/pages/me/new/index' })}>
                <Text className="top-icon-btn-text">＋</Text>
              </View>
              <View className="top-icon-btn top-icon-btn-active" onClick={() => Taro.navigateTo({ url: '/pages/me/shares/index' })}>
                <Text className="top-icon-btn-text">☰</Text>
              </View>
              <View className="top-icon-btn">
                <View className="top-avatar-sm">
                  <Text className="top-avatar-sm-text">{(user.displayName || user.email).slice(0, 1).toUpperCase()}</Text>
                </View>
              </View>
            </>
          ) : (
      ...
      <View className="action-card" onClick={gotoScan}>
        <View className="action-card-left">
